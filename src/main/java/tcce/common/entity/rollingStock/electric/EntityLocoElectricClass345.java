...
public class EntityLocoElectricClass345 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityLocoElectricClass345(World world) {
        super(world);

    }

    public EntityLocoElectricClass345(World world, double d, double d1, double d2) {
        this(world);
