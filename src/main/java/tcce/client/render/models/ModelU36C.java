...
public class ModelU36C extends ModelConverter //Same as Filename
{
	...
	public ModelU36C() //Same as Filename
	{
		...
		bodyModel[25] = new ModelRendererTurbo(this, 68, 4, textureX, textureY, BoxName.lamp); // Box 117 liveryimg 2
		bodyModel[26] = new ModelRendererTurbo(this, 68, 8, textureX, textureY, BoxName.lamp); // Box 118 liveryimg 2
		...
		bodyModel[90] = new ModelRendererTurbo(this, 451, 57, textureX, textureY, BoxName.lamp); // Box 240 liveryimg 2
		bodyModel[91] = new ModelRendererTurbo(this, 439, 57, textureX, textureY, BoxName.lamp); // Box 241 liveryimg 2
		...
		bodyModel[102] = new ModelRendererTurbo(this, 55, 121, textureX, textureY, BoxName.cull); // Box 278 cul
		bodyModel[103] = new ModelRendererTurbo(this, 46, 109, textureX, textureY, BoxName.cull); // Box 279 cul
		bodyModel[104] = new ModelRendererTurbo(this, 61, 16, textureX, textureY, BoxName.lamp); // Box 186 lamp
		bodyModel[105] = new ModelRendererTurbo(this, 68, 16, textureX, textureY, BoxName.lamp); // Box 187 lamp
		...
		bodyModel[137] = new ModelRendererTurbo(this, 421, 62, textureX, textureY, BoxName.lamp); // Box 273 lamp
		bodyModel[138] = new ModelRendererTurbo(this, 421, 67, textureX, textureY, BoxName.lamp); // Box 274 lamp
		...
		bodyModel[146] = new ModelRendererTurbo(this, 157, 21, textureX, textureY, BoxName.prime4); // Prime1-4
		...
		bodyModel[197] = new ModelRendererTurbo(this, 154, 18, textureX, textureY, BoxName.prime3); // Prime1-3
		bodyModel[198] = new ModelRendererTurbo(this, 154, 24, textureX, textureY, BoxName.prime1); // Prime1-1
		bodyModel[199] = new ModelRendererTurbo(this, 151, 21, textureX, textureY, BoxName.prime2); // Prime1-2
		...
		bodyModel[227] = new ModelRendererTurbo(this, 23, 49, textureX, textureY, BoxName.lamp); // Box 307 glowey
		bodyModel[228] = new ModelRendererTurbo(this, 23, 54, textureX, textureY, BoxName.lamp); // Box 308 glowey
		...
		bodyModel[260] = new ModelRendererTurbo(this, 46, 89, textureX, textureY, BoxName.cull); // Box 279 cul
